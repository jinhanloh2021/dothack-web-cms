...
import { FlyInOnScroll, ImageHoverScale } from './excoCardAnimations';
  ...
  return (
    <FlyInOnScroll>
      {src ? (
        ...
        <div className='h-[20rem] w-[16rem] rounded-lg flex flex-col justify-end bg-zinc-200 dark:bg-[#282828]'>
          <svg
